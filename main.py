...
sign_list = '. ? ! , ; : \' — ( ) " « »'.split ()
for x in sign_list:
    text_str = text_str.replace (x, no_sign)
print (text_str)

# сформировать list со словами (split);

print ()
text_list: object = text_str.split ()
print (text_list)
print ()
...
print ()
text_str_map: List [Any] = list (map (lambda x: x.lower (), text_str))
print (text_str_map)
print ()
...
print ()
text_str: Dict [Any, Any] = {}
for count_word in text_str_map:
    count_words: Union [int, Any] = text_str.get (count_word, 0)
    text_str [count_word] = count_words + 1
print (text_str)

#  вывести 5 наиболее часто встречающихся слов (sort), вывести количество разных слов в тексте (set).

print ()
text_str = list (text_str.items ())
text_list
print (text_str [:5])
print (set (text_str_map), len (set (text_str_map)))
